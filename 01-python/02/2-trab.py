...
def calc_parabola(velocidade, radiano):
    ...
    trajeto = True
    while trajeto:
        if parabola['tempo'] == 0 or calc_altura(parabola['tempo'], radiano, velocidade) > 0:
...
print('*******************************************')
print('Distância percorida: {:.1f} metros'.format(parabola['distancias'][-1]))
print('Altura máxima atingida: {:.1f} metros'.format(max(parabola['alturas'])))
print('Duração do lançamento: {:.1f} segundos'.format(parabola['tempo']))
print('*******************************************')